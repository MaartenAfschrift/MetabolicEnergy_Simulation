...
% of Umberger2010. Energy_total is in W/kg and should be multiplied by the
...
function [energy_total,energy_am,energy_sl,energy_mech] = ...
    getMetabolicEnergyNonSmooth2010(exc,act,lMtilde,vMtilde,vM,Fce, ...
...
energy_mech(ind_lv_1,1) = -1*Fce(ind_lv_1,1).*vM(ind_lv_1,1)./musclemass(ind_lv_1,1);
energy_mech(ind_lv_2,1) = 0;
energy_mech(ind_lv_3,1) = -1*Fce(ind_lv_3,1).*vM(ind_lv_3,1)./musclemass(ind_lv_3,1);
energy_mech(ind_lv_4,1) = 0;
