...
function [energy_total,energy_am,energy_sl,energy_mech,energy_model] = ...
    getMetabolicEnergySmooth2016allmuscles(exc,act,lMtilde,vMtilde,vM,Fce, ...
...
f_rec_slow = getPctSTSmooth_allmuscles(exc,pctst_mat,b);                                
...
coef_hl     = 4*coef_hs_st_mat; % different compared to Umberger2010

hdotsl = coef_hl.*vMtilde + (-coef_hl.*vMtilde ...
    - coef_hs_st_mat.*vMtilde.*f_rec_slow ...
    - coef_hs_ft_mat.*vMtilde.*f_rec_fast).*vMtilde_neg;
...
energy_mech = -1*Fce.*vM./musclemass_mat; % different compared to Umberger2010
