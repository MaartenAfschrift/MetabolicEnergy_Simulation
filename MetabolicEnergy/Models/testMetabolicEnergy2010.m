...
[energy_total_sm,energy_am_sm,energy_sl_sm,energy_mech_sm] = ...
    getMetabolicEnergySmooth2010(exc,act,lMtilde,vMtilde,vM,FT,...
                                 musclemass,pctst,vcemax,Fiso,b);
                         
% Smooth version all
[energy_total_sm_all,~,~,~,energy_model_sm_all] = ...
    getMetabolicEnergySmooth2010all(exc,act,lMtilde,vMtilde,vM,FT,...
                                    musclemass,pctst,vcemax,Fiso,...
                                    modelmass,b);                         
...
[energy_total_sm_SX,energy_am_sm_SX,energy_sl_sm_SX,energy_mech_sm_SX] = ...
    getMetabolicEnergySmooth2010(exc_SX,act_SX,lMtilde_SX,vMtilde_SX,vM_SX,FT_SX,...
                             musclemass_SX,pctst_SX,vcemax_SX,Fiso_SX,b_SX);
fgetMetabolicEnergySmooth2010 = Function('fgetMetabolicEnergySmooth2010',...
...
[energy_total_sm_SX_t,energy_am_sm_SX_t,energy_sl_sm_SX_t,energy_mech_sm_SX_t] = ...
    fgetMetabolicEnergySmooth2010(exc,act,lMtilde,vMtilde,vM,FT,musclemass, ...
                             pctst,vcemax,Fiso,b);                         
                         
assertResultsa = max(abs(energy_total-energy_total_sm));
assertResultsb = max(abs(energy_total_sm-full(energy_total_sm_SX_t)));
assertEnergymodel = ((sum(energy_total_sm_all)+1.2*modelmass ...
    -energy_model_sm_all) == 0);
